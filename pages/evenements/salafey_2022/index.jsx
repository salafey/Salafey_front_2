  ...
  return (
    <div>
      ...
      <section id="events">
        ...
        >
          <SousTitre_1>
            Coupure du ruban symbolique d'ouverture des stands par le Ministère
            des Arts et de la Culture
          </SousTitre_1>

          <p>
            Nous allons tous à la découverte des stands de livres pour  enfants,
            des stands de jeux et des stands de contes. Notons que parmi ces
            livres africains pour enfants, figurent des livres écrits en
            diverses langues africaines qui viennent  renforcer l’idée du thème
            « Mon identité ». Des interventions autour du thème du Salon, du
            numérique comme moyen d’épanouissement et de créativité positive,
            et bien d’autres ont donné de l’allure à cette  cérémonie
            d’ouverture. Un thème très  communicateur et interpellatif qui
            invite l’africain authentique à s’identifier davantage à sa culture
            à travers les contes, les livres puisés de ses traditions et les
            jouets typiquement africains.
          </p>
        </EventComponent_2>
        <EventComponent_2
        ...
        >
          <SousTitre_1>
            Conférence inaugurale à la salle des convivialités du Musée national
            du Cameroun
          </SousTitre_1>

          <p>
            La conférence inaugurale a eu lieu le 16 décembre dans la salle des
            convivialités du Musée national avec comme intervenants : Serge
            Alain Dzotap, Parrain du SALAFEY 2022, Arielle Kitio, CEO de CAYSTI,
            Pabe  Mongo, Coordonnateur du pôle des arts littéraires, Ndika
            Tandjong, Directeur de la Fondation Muna, Daniel Nadjiber,
            Coordonnateur du pôle des éditeurs et le Ministère des arts et de la
            culture.  Suite à ces divers échanges, l’immense foule – enfants,
            parents, directeurs d’écoles, artistes, écrivains, etc. – présente a
            assisté à la coupure du ruban symbolique et à l’ouverture officielle
            des stands.
          </p>
        </EventComponent_2>
        <EventComponent_2
        ...
        >
          ...
          <p>
            Lecture à voix haute avec le Parrain de la première édition du Salon
            du Livre Africain pour Enfants de Yaoundé -SALAFEY, Alain Serge
            Dzotap. C'était d'ailleurs l'un des moments favoris pour les enfants
            qui ont eu la chance de côtoyer d'un des meilleurs raconteur de
            belles histoires au enfants que le Cameroun et l'Afrique comptent en
            ce moment. L' objectif était de stimuler la lecture-plaisir chez les
            enfants, outil de promotion de l'excellence scolaire et de
            transmission des valeurs socio-culturelles à ces derniers.
          </p>
        </EventComponent_2>
      </section>
      <Banniere_second
      ...
      <EvenIntro image={'https://media.graphassets.com/1q7m8hFqRAO8UDBgp5pJ'}>
        ...
        <p>
          ...
          nos actions, nous avons offert aux tout petits de magnifiques moments
          d'initiation à la photographie avec la professionnelle du Cinéma
          Tatiane Tchiguia. Ils ont adoré !
        </p>
      </EvenIntro>
